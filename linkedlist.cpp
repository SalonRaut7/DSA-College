...
int main()
{
    ...
    while (1)
    {
        ...
        cout << "Enter 4 to display the elements of the list" << endl;
        cout << "Enter 5 to delete from the beginning" << endl;
        cout << "Enter 6 to delete from the end" << endl;
        cout << "Enter 7 to delete from the specified index" << endl;
        cout << "Enter 8 to insert before a specified position" << endl;
        cout << "Enter 9 to insert after a specified position" << endl;
        ...
        case 2:
            ...
            break;
        case 3:
            cout << "In which index/position you want to insert: " << endl;
            cin >> index;
            cout << "Enter data to be added in the given index: ";
            cin >> info;
            head = insertatindex(head, info, index);
